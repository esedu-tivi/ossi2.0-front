                ...
                <Table>
                    <TableHead>
                        <TableRow className="table-header">
                            <TableCell className="table-header-cell table-header-id" onClick={() => handleSort('id')}>
                                ID#
                                {sortConfig.key === 'id' &&
                            ...
                            <TableCell className="table-header-cell table-header-name" onClick={() => handleSort('firstName')}>
                                Nimi
                            ...
                            <TableCell className="table-header-cell table-header-group" onClick={() => handleSort('groupId')}>
                                Ryhmä
                            ...
                            <TableCell className="table-header-cell table-header-qualification" onClick={() => handleSort('studyingQualificationTitle')}>
                                Ammattinimike
                            ...
                            <TableCell className="search-cell">
                                <div className="search-container">
                                    <SearchIcon />
                                    <TextField placeholder="Hae…" variant="outlined" size="small" value={searchQuery} onChange={handleSearchChange} />
                                </div>
                            </TableCell>
                        </TableRow>
                    </TableHead>
